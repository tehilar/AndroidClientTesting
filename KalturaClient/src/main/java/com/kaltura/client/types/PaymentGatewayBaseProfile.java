...
public class PaymentGatewayBaseProfile extends ObjectBase {
    ...
    public static final Creator<PaymentGatewayBaseProfile> CREATOR = new Creator<PaymentGatewayBaseProfile>() {
        @Override
        public PaymentGatewayBaseProfile createFromParcel(Parcel source) {
            return new PaymentGatewayBaseProfile(source);
        }

        @Override
        public PaymentGatewayBaseProfile[] newArray(int size) {
            return new PaymentGatewayBaseProfile[size];
        }
    };
    ...
    public PaymentGatewayBaseProfile(Parcel in) {
        super(in);
